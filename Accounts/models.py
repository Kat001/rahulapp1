...
class Account(AbstractBaseUser):
	...
	date_active				= models.DateTimeField(verbose_name='date active', default = '2000-01-01 06:00')
	...
	sponser  				= models.CharField(max_length=30, unique=False,blank=True,null=True)
	upline                  = models.CharField(max_length=30, unique=False,blank=True,null=True)
	downline                = models.CharField(max_length=30, unique=False,blank=True,null=True)
